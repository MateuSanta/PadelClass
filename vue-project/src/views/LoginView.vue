        ...
        <div class="w-full bg-white rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form id="form" class="space-y-4 md:space-y-6" method="post" >
                    ...
                    <button type="button"  @click="validate()" class="w-full focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  bg-slate-400  hover:bg-slate-200 focus:ring-primary-800">Sign in</button>
