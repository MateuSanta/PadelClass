...
<template>
  <main class="flex flex-col place-items-center font-[Montserrat]">
    ...
    >
      <h1 class="text-6xl text-[#db811a] font-medium">Equipo</h1>
    </div>
      ...
      <div class="group my-10 h-60 xl:w-[30rem] [perspective:1000px]">
        ...
        >
          <div class="absolute inset-0">
            <img
              class="h-full w-full bg rounded-xl object-cover shadow-xl shadow-black/40"
              :src="person.imagen"
              alt=""
            />
            <div
              class="absolute flex flex-col place-items-center w-10 h-10 rounded-full right-10 top-1/2 -translate-y-1/2 border-[1px] border-slate-900"
            >
