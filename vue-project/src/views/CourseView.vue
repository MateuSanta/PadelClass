...
<template>
  <main class="flex flex-col place-items-center">
    <div class="flex flex-col font-extralight w-full py-0">
      ...
      <div
        class="flex flex-col xl:flex-row place-self-center mt-[6rem] justify-center w-[300px] h-[600px] xl:h-[300px]"
      >
        <div class="flex my-5 mx-10 items-start h-32 xl:w-[20rem]">
          <div
            :class="{
              'scale-125': nivelIniciacion,
              'shadow-[#2f4355]': nivelIniciacion,
              'contrast-125': nivelIniciacion,
            }"
          ...
          >
            <button
              @click="
                ...
                nivelAvanzado = false;
              "
              class="font-medium opacity-70 p-10 hover:opacity-100 text-3xl"
            >
              Iniciación
            </button>
          </div>
        ...
        <div class="flex my-5 h-32 mx-10 xl:w-[20rem]">
          <div
            :class="{
              'scale-125': nivelIntermedio,
              'shadow-[#db811a]': nivelIntermedio,
              'contrast-125': nivelIntermedio,
            }"
        ...
        <div class="flex my-5 mx-10 justify-center h-32 xl:w-[20rem]">
          <div
            :class="{
              'scale-125': nivelAvanzado,
              'shadow-[#ca1d51]': nivelAvanzado,
              'contrast-125': nivelAvanzado,
            }"
          ...
          >
            <button
              @click="
                ...
                nivelAvanzado = true;
              "
              class="text-[#ca1d51] rounded-xl p-10 opacity-70 hover:opacity-100 font-medium text-3xl"
            >
              Avanzado
            </button>
          </div>
      ...
      <hr
        class="flex place-self-center justify-center w-1/2 h-[1px] border-0 rounded md:my-3 bg-[#969494]"
      />
    </div>
    <ul
      :class="{
    ...
    >
      <li v-for="card in cardsFilter">
        <div
          ...
          :class="{
            'shadow-[#ca1d51]': nivelAvanzado,
            'shadow-[#cb9f64]': nivelIntermedio,
            'shadow-[#2f4355]': nivelIniciacion,
            'shadow-[#374755]': filterReset,
            'shadow-[#57b570]': filterGratuito,
          }"
        ...
        >
          <div class="rounded border-[#30475D] bg-[white] w-[250px] h-[400px]">
            ...
            <div class="flex flex-col place-items-center p-6">
              ...
              <router-link
                class="w-28 inline-block flex-end px-6 py-2.5 bg-slate-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-[#db811a] hover:shadow-lg"
                :to="{ path: '/course/card/' + card.id }"
              >
                ENTRAR</router-link
              >
            </div>
